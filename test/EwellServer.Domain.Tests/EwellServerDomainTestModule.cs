...
[DependsOn(
    typeof(EwellServerTestBaseModule)
)]
public class EwellServerDomainTestModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.Configure<IndexSettingOptions>(options =>
        {
            ...
            options.IndexPrefix = "EwellServertest";
        });
    }
        ...
        modules.ForEach(m =>
        {
            ...
            foreach (var t in types)
            {
                AsyncHelper.RunSync(async () =>
                    await elasticIndexService.DeleteIndexAsync("EwellServertest." + t.Name.ToLower()));
            }
        });
    }
